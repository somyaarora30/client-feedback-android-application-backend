...
$query = "UPDATE transaction3_db set answer1='$answer1' WHERE event_date3 = '$event_date' and event_location3 = '$event_location' and organisation_name3 = '$organisation_name' order by transaction_id3 desc limit 1";
